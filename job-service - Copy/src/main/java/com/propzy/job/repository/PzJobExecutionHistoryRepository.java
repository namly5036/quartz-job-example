...
@Repository
public interface PzJobExecutionHistoryRepository extends JpaRepository<PzJobExecutionHistory, UUID> {

    Optional<PzJobExecutionHistory> findFirstById(String id);
